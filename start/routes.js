...
Route.group(() => {
  Route.post('/convert-to-db', 'ConvertToDatabaseController.index');
  Route.get('/get-workspaces', 'ConvertToDatabaseController.getWorkspaces');
  Route.get('/file', 'ConvertToDatabaseController.getFiles');
}).prefix('api/v2');
Route.group(() => {
